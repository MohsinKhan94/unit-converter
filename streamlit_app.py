...
# Display the result without complex styling
col2.subheader(f"Result: {result:.{decimal_places}f} {to_unit}")
col2.caption(f"Formula: {get_formula(from_unit, to_unit, category, from_value, result, decimal_places)}")
...
# Simple footer
st.caption("Unit Converter - Simple, Fast, Reliable") 